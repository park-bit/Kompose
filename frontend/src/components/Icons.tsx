...
export function TrainIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M8 4h8a2 2 0 012 2v10a2 2 0 01-2 2H8a2 2 0 01-2-2V6a2 2 0 012-2zm-2 16l-2 2m14-2l2 2M9 14h.01M15 14h.01M7 9h10" />
    </svg>
  );
}
...
export function CarIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10M13 6h4.586a1 1 0 01.707.293l3.414 3.414A1 1 0 0122 10.414V16h-3" />
    </svg>
  );
}
...
export function StarIcon({ className = "w-3.5 h-3.5 text-amber-400" }: { className?: string }) {
  return (
